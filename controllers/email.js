...
exports.mail = (req, res) => {
    ...
    const emailData = {
      ...
      <p>Thank you for registering with Edumax.edu.ng - The Education platform that service all school automation related needs.     </p>
      ...
      <p>   Do not respond to this email, please contact us directly at support@edumax.edu.ng</p>
